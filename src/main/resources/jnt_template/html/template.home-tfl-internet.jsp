...
<%@ page language="java" contentType="text/jnt_searchResults.html;charset=UTF-8"%>
...
<head>
<meta http-equiv="Content-Type" content="text/jnt_searchResults.html; charset=utf-8" />
